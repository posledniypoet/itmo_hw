...
map_minKey(tree((TreeKey,TreeValue,TreePriority), nil, TreeRight), TreeKey) :- !.
map_minKey(tree((TreeKey,TreeValue, TreePriority), TreeLeft, TreeRight), Key) :-
  map_minKey(TreeLeft, Key), !.


map_maxKey(tree((TreeKey,TreeValue, TreePriority), TreeLeft, nil), TreeKey) :- !.
map_maxKey(tree((TreeKey,TreeValue, TreePriority), TreeLeft, TreeRight), Key) :-
  map_maxKey(TreeRight, Key), !.
